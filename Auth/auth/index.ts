...
export function authorizationChecker(connection: DataSource, jwtSecret: string, cryptoSecret: string, additionalInfo: any): (action: Action, roles: string[]) => Promise<boolean> | boolean {
